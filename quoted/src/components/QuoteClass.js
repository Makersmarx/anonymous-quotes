  ...
  render() {
    return (
      <div className='quotes'>
        {this.state.edit ? (
            <div>
              <input value={this.state.quote} onChange={(e) => this.handleChange(e.target.value)} />
            ...
            <button className='leftbutton' onClick={this.toggleEdit}>Edit</button>
            <button className='rightbutton' onClick={() => this.props.deleteQuote(this.props.info.id)}>
              Delete
            </button>
          </div>
        )}
